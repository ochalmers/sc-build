    ...
    <div className="mx-5 mt-3 rounded-2xl border p-3.5" style={{ borderColor: LINE }}>
      ...
      <div className="mt-2 flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-[12px] font-semibold">Session 1</p>
  ...
  return (
    <WireframePhone>
      ...
      <div className="mt-2 flex-1 overflow-hidden">
        <MiniRow title="Session 1" meta="14 min · Assigned" />
        <MiniRow title="Session 2" meta="22 min · Evening" />
        <MiniRow title="Session 3" meta="18 min · Daytime" />
      </div>
      <NavBar
        active="home"
        items={[
  ...
  return (
    <WireframePhone>
      ...
      <div className="mt-3 flex flex-1 flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-4 text-[13px] font-bold">Session 1</p>
  ...
  return (
    <WireframePhone>
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 px-5">
        {["Session 1", "Session 2", "Session 3", "Session 4"].map((t) => (
