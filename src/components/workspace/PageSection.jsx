export default function PageSection({ id, label, title, description, children, className = "", fullWidth = false }) {
  return (
    <section
      id={id}
      className={`scroll-mt-[7rem] border-b border-ink-200/60 py-20 md:py-28 ${className}`}
    >
      <div className={fullWidth ? "px-6" : "max-w-content mx-auto px-6"}>
