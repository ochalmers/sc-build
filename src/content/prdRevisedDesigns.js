...
export const PRD_DESIGNS_NAV = [
  { label: "Overview", href: "#prd-designs-intro" },
  { label: "Public Visitor", href: "#prd-designs-public" },
  { label: "Golden route", href: "#prd-designs-golden" },
  { label: "Public screens", href: "#prd-designs-pv-screens" },
  { label: "Mobile App PRD", href: "#prd-designs-mobile" },
  { label: "Listener journey", href: "#prd-designs-listener" },
  { label: "Partner & Admin", href: "#prd-designs-ops" },
];
