...
export const PROJECT_SUMMARY_SECTIONS = [
  {
    ...
    description:
      "Internal workspace for the June 2026 PRDs — flows, hi-fi designs, and a clickable prototype. Start with the two PRDs below.",
    body: [
  ...
  },
  {
    ...
    bullets: [
      ...
      { term: "Prototype", detail: "Clickable tap-through preview on your phone frame." },
      { term: "Plan", detail: "Delivery timeline, pre-holiday milestones, and phase gates." },
