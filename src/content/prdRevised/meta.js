...
export const REVISED_NAV = [
  { label: "Overview", href: "#revised-intro" },
  { label: "PRD relationship", href: "#revised-relationship" },
  { label: "Roles", href: "#revised-roles" },
  { label: "Public Visitor stories", href: "#revised-pv-stories" },
  { label: "Golden route", href: "#revised-golden-route" },
  { label: "Public flows", href: "#revised-pv-flows" },
  { label: "Public screens", href: "#revised-pv-screens" },
  { label: "Mobile stories", href: "#revised-mobile-stories" },
  { label: "Mobile screens", href: "#revised-mobile-screens" },
  { label: "Functional flows", href: "#revised-functional" },
  { label: "Clinical contexts", href: "#revised-clinical" },
  { label: "Scope & future", href: "#revised-scope" },
];
