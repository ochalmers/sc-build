export const DELIVERY_PLAN_META = {
  title: "Sonocea Mobile App v1.0 LITE",
  subtitle: "Four-Stage Design Delivery Plan",
  description:
    "A focused design programme taking the product from PRD alignment through to wireframes, visual language, high-fidelity prototype and engineering handoff. A substantial pre-holiday chunk — all PRD-identified flows plus two high-fidelity concepts — lands by June 16 for async team review.",
  dateRange: "June 9 – July 12, 2026",
};

/** Work delivered before Oli's holiday (async review starts Jun 17). */
export const DELIVERY_PLAN_PRE_HOLIDAY = {
  title: "Pre-holiday delivery",
  dates: "By June 16",
  holidayWindow: "June 17–22",
  objective:
    "Land a reviewable body of work before the holiday so the team can async-review the full PRD flow catalogue and early visual direction while design is paused.",
  deliverables: [
    {
      category: "PRD flow wireframes",
      summary:
        "Complete wireframe coverage for every flow identified from PRD v1.0 — listener, partner, admin, public, billing, platform, and clinical contexts.",
      items: [
        "Listener · mobile — core journeys",
        "Listener · edge cases",
      ...
      note: "Published on the flows microsite; mirrored in Figma and Paper.",
    },
    {
      category: "High-fidelity concepts",
      summary:
        "Two polished screen explorations to test visual direction ahead of the full design-system pass.",
      items: [
        "Concept A — key listener moment (e.g. library or onboarding)",
        "Concept B — key listener moment (e.g. session detail or player)",
      ],
      note: "Directional explorations, not final production screens — enough to anchor async visual feedback.",
    },
  ],
  supporting: [
    "MVP scope definition and in / out / under review matrix",
    "Simplified information architecture",
    "Key screen inventory",
    "Inspiration and reference board",
  ],
  asyncNote:
    "June 17–22 is async review only. The team comments on flows and concepts; feedback is consolidated before design resumes June 23.",
};

export const DELIVERY_PLAN_TIMELINE = [
  { id: "phase-1", label: "Phase 1", dates: "Jun 9–16", type: "phase" },
  { id: "async-review", label: "Async Review", dates: "Jun 17–22", type: "async" },
  { id: "phase-2", label: "Phase 2", dates: "Jun 23–29", type: "phase" },
  { id: "phase-3", label: "Phase 3", dates: "Jun 30–Jul 6", type: "phase" },
  { id: "phase-4", label: "Phase 4", dates: "Jul 7–12", type: "phase" },
];
...
export const DELIVERY_PLAN_PRODUCT_AREAS = [
  {
    role: "Listener App",
    surface: "Primary product",
    summary:
      "Guest landing, invite redemption, onboarding, neurotype assessment, listening guidance, session library, player, feedback, and support.",
    priority: true,
  },
  {
...
export const DELIVERY_PLAN_PHASES = [
  {
    ...
    preHoliday: true,
    objective:
      "Align on MVP scope and deliver the full PRD-identified flow catalogue plus two high-fidelity concepts — everything the team needs to review asynchronously during the holiday window.",
    activities: [
      "Review PRD Lite and confirm scope decisions",
      "Finalise MVP feature set and information architecture",
      "Wireframe all PRD-identified flows (listener, partner, admin, public, billing, platform, clinical)",
  ...
  {
    id: "plan-async-review",
    number: null,
    title: "Async Review Window",
    dates: "June 17–22",
    variant: "async",
    objective:
      "Give the team time to review the Phase 1 outputs while Oli is away, without creating design churn.",
    activities: [
      "Team reviews Figma and microsite materials asynchronously",
      "Comments are added directly into the relevant sections",
      "Open questions are collected",
      "Feedback is consolidated into one decision list",
      "No new design direction should be started during this period",
    ],
    deliverables: [
      "Consolidated feedback list",
      "Resolved / unresolved decision log",
      "Prioritised revisions for Phase 2",
    ],
    feedback: {
      title: "Async comments only",
      method: true,
      note: "Feedback should be consolidated by Sarah / Anthony before Phase 2 begins so that revisions are focused and not fragmented.",
    },
    signOff: [
      "No formal sign-off during this period. The aim is to prepare clear feedback for when Oli returns.",
    ],
  },
  {
    id: "plan-phase-2",
    ...
    dates: "June 23–29",
    objective:
      "Refine the pre-holiday flow catalogue and wireframes based on consolidated async feedback.",
    activities: [
      "Revise flows based on async feedback",
...
export const DELIVERY_PLAN_OUTPUTS = [
  ...
  },
  {
    category: "UX",
    items: [
      "Full PRD flow wireframe catalogue (pre-holiday)",
      "Revised wireframes post-async review",
      "Navigation model",
      "Screen-by-screen content structure",
    ],
  },
  {
    category: "UI",
    items: [
      "Two high-fidelity concepts (pre-holiday)",
      "Visual language",
...
export const DELIVERY_PLAN_CHECKPOINTS = [
  {
    phase: "Pre-holiday",
    gate: "All PRD flows wireframed + two hi-fi concepts delivered",
    date: "Jun 16",
    highlight: true,
  },
  {
    phase: "Phase 1",
    gate: "MVP scope, IA and flow catalogue signed off",
    date: "Jun 16",
  },
  {
    phase: "Async Review",
    gate: "Feedback consolidated for Phase 2",
    date: "Jun 22",
  },
  {
    phase: "Phase 2",
...
export const DELIVERY_PLAN_CHAPTERS = [
  ...
  { id: "plan-pre-holiday", label: "Pre-holiday", shortLabel: "Pre-holiday", href: "#plan-pre-holiday" },
