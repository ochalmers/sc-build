...
import { SuccessStateScreen } from "../phase1/screens/listener/CoreScreens.jsx";
import {
...
export const PRD_SCREEN_REGISTRY = {
  ...
  "auth-success": screen(SuccessStateScreen, { variant: "invite-redeemed" }),
  completion: screen(SuccessStateScreen, { variant: "session-completed" }),
  "onboarding-complete": screen(SuccessStateScreen, { variant: "profile-completed" }),
  "science-support": screen(PvScienceHomeScreen),
  research: screen(AboutScreen),
  support: screen(AboutScreen),
  settings: screen(AboutScreen),
};
