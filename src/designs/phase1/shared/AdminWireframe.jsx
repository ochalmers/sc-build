/** Minimal wireframe chrome for Partner & Admin concept screens */

export function AdminPhone({ label, children }) {
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden bg-[#F4F4F5]">
      <div className="border-b border-[#E4E4E7] bg-white px-4 pb-3 pt-10">
        <span className="inline-block rounded-full bg-[#E4E4E7] px-2 py-0.5 text-[8px] font-medium uppercase tracking-wider text-[#71717A]">
          Wireframe
        </span>
        <p className="mt-2 text-[11px] font-semibold text-[#18181B]">{label}</p>
      </div>
