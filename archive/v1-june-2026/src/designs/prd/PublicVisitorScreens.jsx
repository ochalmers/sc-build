...
export function PvCheckInScreen({ variant = "before", prototypeActions = {} }) {
  ...
  const gradient = after
    ? "radial-gradient(ellipse at 50% 20%, rgba(180,200,220,0.35) 0%, transparent 55%)"
    : "radial-gradient(ellipse at 50% 15%, rgba(230,180,150,0.4) 0%, rgba(200,120,90,0.25) 45%, transparent 70%)";
  return (
    <PublicShell gradient={gradient}>
