# Sonocea system assets

Drop exportable brand and product files here. Paths are stable for decks, microsites, and tooling.

| Folder | Use |
|--------|-----|
| `fonts/` | Licensed desktop/web font files (by family, e.g. `fonts/aeonik-pro/`) |
| `logos/` | Wordmarks, logomarks, SVG lockups |
...
Root-level `palette-reference.svg` is a quick colour strip for decks.
